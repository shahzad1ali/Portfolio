  ...
  return (
    <div className="w-full h-full relative">
      ...
      >
        ...
        className="w-[298px] h-[298px] xl:w-[498px] xl:h-[498px] mix-blend-lighten rounded-full absolute overflow-hidden"
        >
          <Image
            src="/assets/2.png"
            priority
            ...
            fill
            alt=""
            className="object-contain -translate-y-12 xl:-translate-y-20"
            style={{
